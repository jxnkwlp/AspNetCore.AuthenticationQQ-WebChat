...
// https://github.com/aspnet/Security/blob/2.1.0/src/Microsoft.AspNetCore.Authentication.OAuth/Events/OAuthCreatingTicketContext.cs
namespace Microsoft.AspNetCore.Authentication.MultiOAuth.Events
{
    /// <summary>
    /// Contains information about the login session as well as the user <see cref="System.Security.Claims.ClaimsIdentity"/>.
    /// </summary>
    public class MultiOAuthCreatingTicketContext : ResultContext<MultiOAuthOptions>
    {
        /// <summary>
        ...
        public MultiOAuthCreatingTicketContext(
            ClaimsPrincipal principal,
            AuthenticationProperties properties,
            HttpContext context,
            AuthenticationScheme scheme,
            MultiOAuthOptions options,
